...
namespace AppBundle\Entity\zeBlog;
 ...
 * Post
 *
 * @ORM\Table(name="ze_blog_post")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\zeBlog\PostRepository")
 */
class Post
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="published", type="string", length=11)
     */
    private $published;
